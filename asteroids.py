...
class Sprite:
    ...
    #To check whether ship and rock collide
...
def rock_spawner():
    global count ,num_of_rocks
    if count < num_of_rocks:
        ...
        if angle_vel > 0.3:
            angle_vel -= 0.4
        rock_group.add(Sprite("Rock",[x, y], [vel_x, vel_y], angle,angle_vel, asteroid_image, asteroid_info))
        count += 1
